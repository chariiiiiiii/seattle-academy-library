...
<body class="wrapper">
    ...
    <main>
    <form action="<%=request.getContextPath()%>/registBook" method="post" enctype="multipart/form-data" id="data_upload_form">
            <h1>一括登録</h1>
          ...
          <div class="bulk_form">
            <h2>CSVファイルをアップロードすることで書籍を一括で登録できます。</h2>
                ...
                <input type="file" accept=".csv" name="upload_file" id="fileContents">
